...
describe('Badge Component', () => {
    ...
    it('Should render both icon and label', () => {
        const { container } = render(
            <Badge visiblity="icon-and-label" prefix_icon={<img alt={'check-icon'} src={CheckIconSVG} />}>
                Badge Text Content
            </Badge>,
        );
    ...
    it('Should render only the label', () => {
        const { container } = render(
            <Badge visiblity="label-only" prefix_icon={<img alt={'check-icon'} src={CheckIconSVG} />}>
                Badge Text Content
            </Badge>,
        );
        const icon = container.querySelector('img') as HTMLImageElement;
    ...
    it('Should render only the icon', () => {
        const { container } = render(
            <Badge visiblity="icon-only" prefix_icon={<img alt={'check-icon'} src={CheckIconSVG} />}>
                Badge Text Content
            </Badge>,
        );
        const icon = container.querySelector('img') as HTMLImageElement;
